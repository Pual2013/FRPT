...
from .retrieval_head import MAM
...
class Saliency_Sampler(nn.Module):
    def __init__(self, cha=256, task_input_size=224, saliency_input_size=224):
    ...
    def forward(self, x, xs):
        ...
        xs = nn.Upsample(size=(self.grid_size,self.grid_size), mode='bilinear', align_corners=True)(xs)
        ...
        x_sampled = F.grid_sample(x.float(), grid.float(), align_corners=True)
